...
Traditional business strategy runs on inherited principles built on ideologies from sports and war.
...
1\. No deadlines or artificial urgency
...
3\. Resonance-Based Hiring (No job postings, recruiters, or traditional hiring)
...
6\. Fluid roles (No hierarchy and no fixed structure)
...
The world is different now. Get out a blank sheet of paper. And build from scratch with independent thinking based on how the World works today
